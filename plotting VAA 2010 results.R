...
# save plot as a pdf
ggsave('~/Documents/Analysis repos/Eutreta-diana-density-quality-experiment/figs/galls~naturalgalls.pdf', 
...
dev.print(pdf, file="~/Documents/Analysis repos/Eutreta-diana-density-quality-experiment/figs/3d VAA 2010.pdf",
